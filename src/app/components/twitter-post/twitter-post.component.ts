...
export class TwitterPostComponent {
  @Input() public baseHref = 'https://github.com/Schweppes-JS';
  @Input() public hashTags: string[] = ['Schweppes', 'JavaScript', 'TypeScript', 'Angular', 'Angular Challenge'];
  ...
  private getBaseWithHashTagsAndRoute() {
    ...
    return `https://twitter.com/intent/tweet?hastags=${encodeURIComponent(hashTags)}$related-pizzapokerguy$url=${route}&text=`;
  }
}
